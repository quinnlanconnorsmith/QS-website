...
role: PhD Candidate - Freshwater and Marine Sciences (test)
...
social:
  ...
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=yMeKwSMAAAAJ&hl=en
# Link to a PDF of your resume/CV.
# To use: copy your resume to `static/uploads/resume.pdf`, enable `ai` icons in `params.yaml`,
# and uncomment the lines below.
# - icon: cv
#   icon_pack: ai
#   link: uploads/QSmith_CV_2025.pdf
...
{{< icon name="download" pack="fas" >}} Download my {{< staticref "uploads/QSmith_CV_2026.pdf" "newtab" >}}CV{{< /staticref >}}.
